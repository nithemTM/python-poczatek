from a3_6_metoda_super.shop.order import Order, ExpressOrder
from a3_6_metoda_super.shop.data_generator import generate_order
from a3_6_metoda_super.shop.discount_policy import DiscountPolicy, PercentageDiscount, AbsoluteDiscount
