import random
from a3_6_metoda_super.shop.order_element import OrderElement
from a3_6_metoda_super.shop.product import Product
from a3_6_metoda_super.shop.order import Order
