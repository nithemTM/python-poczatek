from a4_9_dataclass.shop.apple import Apple
from a4_9_dataclass.shop.potato import Potato
from a4_9_dataclass.shop.product import Product, ProductTerm
from a4_9_dataclass.shop.order_element import OrderElement
