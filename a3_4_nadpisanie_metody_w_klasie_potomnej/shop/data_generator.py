import random
from a3_4_nadpisanie_metody_w_klasie_potomnej.shop.order_element import OrderElement
from a3_4_nadpisanie_metody_w_klasie_potomnej.shop.product import Product
from a3_4_nadpisanie_metody_w_klasie_potomnej.shop.order import Order
