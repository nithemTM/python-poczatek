from sekcja_4_wbudowane_struktury_danych.a4_9_dataclass.shop.apple import Apple
from sekcja_4_wbudowane_struktury_danych.a4_9_dataclass.shop.potato import Potato
from sekcja_4_wbudowane_struktury_danych.a4_9_dataclass.shop.product import Product, ProductTerm
from sekcja_4_wbudowane_struktury_danych.a4_9_dataclass.shop.order_element import OrderElement
...
def call_object():
    ...
    frozen_pizza = ProductTerm(name="Pizza margherita", category_name="Italian Food", unit_price=20,
                               year_production=2020, amount_years=4)
    print(circular_saw)
    print(frozen_pizza)

    order_elements = OrderElement(circular_saw, 5)
