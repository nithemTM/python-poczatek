from sekcja_4_wbudowane_struktury_danych.a4_10_enum.shop.data_generator import generate_order
from sekcja_4_wbudowane_struktury_danych.a4_10_enum.shop.order import Order
from sekcja_4_wbudowane_struktury_danych.a4_10_enum.shop.discount_policy import DiscountPolicy


def call_object():
    # Zad 1
    policy = DiscountPolicy()
    order_random = generate_order(7)
