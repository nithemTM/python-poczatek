from sekcja_5_obsluga_bledow_i_pliki.a5_3_blok_try_except_lapanie_wyjatkow.shop.data_generator import generate_order
from sekcja_5_obsluga_bledow_i_pliki.a5_3_blok_try_except_lapanie_wyjatkow.shop.order import Order
from sekcja_5_obsluga_bledow_i_pliki.a5_3_blok_try_except_lapanie_wyjatkow.shop.discount_policy import DiscountPolicy
from sekcja_5_obsluga_bledow_i_pliki.a5_3_blok_try_except_lapanie_wyjatkow.shop.product import Product, ProductCategory
from sekcja_5_obsluga_bledow_i_pliki.a5_3_blok_try_except_lapanie_wyjatkow.shop.error_expectation import \
    MaxLimitExpectation
from sekcja_5_obsluga_bledow_i_pliki.a5_3_blok_try_except_lapanie_wyjatkow.shop.user_interface import handle_customer


def call_object():
    policy = DiscountPolicy()

    order_random = generate_order(11)
    # Zad 1
    try:
        order = Order(customer_first_name="Mateusz", customer_last_name="Tokarski", discount_policy=policy, order_elements=order_random)
        order.order_elements = generate_order(11)
        print(order)
        ...
        print(order)
    except MaxLimitExpectation as error:
        print(f"Przekroczono limit zamówienia!")
        # Zad 2
        print(f"Szczegóły blędu: {error}")
    # Zad 3
    handle_customer()
