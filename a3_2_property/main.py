from a3_2_property.shop.order import Order
from a3_2_property.shop.discount_policy import default_policy, discount_all_item, discount_holiday
from a3_2_property.shop.data_generator import generate_order
