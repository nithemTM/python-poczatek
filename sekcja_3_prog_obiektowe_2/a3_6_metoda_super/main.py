from sekcja_3_prog_obiektowe_2.a3_6_metoda_super.shop.order import ExpressOrder
from sekcja_3_prog_obiektowe_2.a3_6_metoda_super.shop.data_generator import generate_order
from sekcja_3_prog_obiektowe_2.a3_6_metoda_super.shop.discount_policy import AbsoluteDiscount
...
def call_object():
    ...
    random_order_term = ExpressOrder(customer_first_name="Mateusz", customer_last_name="Tokarski",
                                     order_elements=order_elements, discount_policy=absolute_policy, delivery_term="20-08-2040")
