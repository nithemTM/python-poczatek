# from a3_3_dziedziczenie.shop.order import Order
# from a3_4_nadpisanie_metody_w_klasie_potomnej.shop.product import ProductTerm

from sekcja_3_prog_obiektowe_2.a3_4_nadpisanie_metody_w_klasie_potomnej.shop.order import ExpressOrder
from sekcja_3_prog_obiektowe_2.a3_4_nadpisanie_metody_w_klasie_potomnej.shop.data_generator import generate_order
from sekcja_3_prog_obiektowe_2.a3_4_nadpisanie_metody_w_klasie_potomnej.shop.discount_policy import discount_holiday
...
def call_object():
    ...
    random_order = ExpressOrder(customer_first_name="Mateusz", customer_last_name="Tokarski",
                                order_elements=order_elements, discount_policy=discount_holiday, delivery_term="12-10-2024")
    print(random_order)
