import random
from a3_5_abstrakcja_i_polimorfizm.shop.order_element import OrderElement
from a3_5_abstrakcja_i_polimorfizm.shop.product import Product
from a3_5_abstrakcja_i_polimorfizm.shop.order import Order
